      ...
      <div className='container mx-auto mb-14'>
        <div className='flex flex-col gap-y-8 lg:flex-row lg:items-center lg:gap-x-12'>
          ...
          <div className='flex-1 text-center font-secondary lg:text-left'>
            ...
            >
              <button className='btn btn-lg'><a href="https://link.shabbydigital.com/widget/booking/7tCsfKqjOw2CMtCXmUkh">Schedule a Call to get a FREE Website Demo Today!</a></button>
            </motion.div>
            {/* socials */}
            <motion.div
